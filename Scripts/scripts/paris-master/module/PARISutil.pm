...
our $VERSION     = '0.01';
our @EXPORT      = ();
our @EXPORT_OK   = qw( readBED readIcSHAPE loadGenome readGTF_ensembl_new getExonLen getExonID get5primeLen getCDSLen get3primeLen getBioType parseCigar reverseComplement localAlignment );
